...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    public void downloadImage(View view) {
        try {
            ...
            downloadIntent = makeDownloadImageIntent(getUrl());
            String title = "Chooser";
// Create intent to show the chooser dialog
            Intent chooser = Intent.createChooser(downloadIntent, title);
            ...
            // method.
            // @@ TODO -- you fill in here.
            //Log.i(TAG, "URL: "+downloadIntent.getAction().toString());

            this.startActivityForResult(chooser, DOWNLOAD_IMAGE_REQUEST);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == DOWNLOAD_IMAGE_REQUEST) {
                ...
                // file.
                // @@ TODO -- you fill in here.
            	Intent galleryIntent = makeGalleryIntent(data.getExtras().getString("url"));
    ...
    private Intent makeDownloadImageIntent(Uri url) {
        ...
        downloadIntent.setAction(Intent.ACTION_WEB_SEARCH);
    ...
    protected Uri getUrl() {
        ...
        if (URLUtil.isValidUrl(url.toString()))
        	...
        	Toast.makeText(this,"Invalid URL", Toast.LENGTH_SHORT).show(); return null;
        	} 
    }
