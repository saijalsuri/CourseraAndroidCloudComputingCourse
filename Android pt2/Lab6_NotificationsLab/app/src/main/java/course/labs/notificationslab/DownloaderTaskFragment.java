...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        List<Integer> dataList = bundle.getIntegerArrayList("friends");
        ...
        downloaderTask.execute(dataArray);
    ...
    public class DownloaderTask extends AsyncTask<Integer, Void, String[]> {
        ...
        protected String[] doInBackground(Integer... resId) {
            ...
            String[] tweets = downloadTweets(resId);
            return tweets;
        }
                    ...
                    new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (getResultCode() != (MainActivity.IS_ALIVE)) {
                                ...
                                Notification.Builder notificationBuilder = new Notification.Builder(mContext).setSmallIcon(android.R.drawable.stat_sys_warning)
                                        .setAutoCancel(true).setContentIntent(restartMainActivityPendingIntent).setContent(mContentView);
